...
static bool bind_socket(void * args)
{
    ...
    socklen_t addrlen = sizeof(bind_socket_data->server_address);
...
static bool receive_from_socket(void * args)
{
    ...
    common_data.rx_byte_len = read(common_data.socket_fd, &common_data.rx_buffer[0], sizeof(common_data.rx_buffer));
...
static bool send_to_socket(void * args)
{
    ...
    common_data.tx_byte_len = write(common_data.socket_fd, &common_data.tx_buffer[0], sizeof(common_data.tx_buffer));
